...
⬡ Upload: ${ago}
⬡ Link: ${url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['VIDEO', `${usedPrefix}ytmp4 ${url}`], false, { quoted: m, 'document': { 'url':'https://wa.me/923494757886' },
...
body: wm,
sourceUrl: 'http://wa.me/923494757886', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
...
handler.help = ['play.test'].map(v => v + ' <query>')
handler.tags = ['downloader']
handler.command = /^play.test$/i
