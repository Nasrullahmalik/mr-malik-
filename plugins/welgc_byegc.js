...
contextInfo: { externalAdReply: { title: ''Mr-Malik', body: '◇●●●●●🇵🇰●●●●●◇️', sourceUrl: ``, thumbnail: imagen1}}})  
}
if (command == 'byegc') {
conn.sendFile(m.chat, stikerbyegc, 'sticker.webp', null, m, false, { 
contextInfo: { externalAdReply: { title: ''M-r M A L I K', body: '□●●●🇵🇰●●●□️', sourceUrl: ``, thumbnail: imagen1}}})
}}
